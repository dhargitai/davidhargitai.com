...
export function Cta({
  ...
  const attributes = {
    className: `inline-block cursor-pointer border-0 border-none bg-slate-900 py-6 px-16 text-center text-lg font-bold text-white hover:bg-white hover:text-slate-900 ${className}`,
    ...(onClick ? { onClick } : {}),
    ...(link ? { to: link } : {}),
    style: {
      transition:
