      ...
      <nav role="navigation" className="block overflow-visible inset-x-0 top-0 px-6 pt-0 pb-8 w-full font-medium leading-8 text-center border-b border-solid border-zinc-200 bg-white text-slate-500"
        ...
        <ul role="list" className="flex flex-col justify-end items-center pl-0 mb-0 leading-8 list-none text-slate-500" style={{listStyle: 'outside none none'}}>
          <li className="py-2 mr-0 mb-4 text-left" style={{listStyle: 'outside none none'}}>
            <a href="/" className="text-2xl leading-4 cursor-pointer text-slate-900 hover:text-slate-500" style={{transition: 'color 300ms ease 0s', textDecoration: 'none', listStyle: 'outside none none'}}>Home</a>
          </li>
          <li className="py-2 mr-0 mb-4 text-left" style={{listStyle: 'outside none none'}}>
            <a href="/about" className="text-2xl leading-4 cursor-pointer text-slate-900 hover:text-slate-500" style={{transition: 'color 300ms ease 0s', textDecoration: 'none', listStyle: 'outside none none'}}>About</a>
          </li>
          <li className="py-2 mr-0 mb-4 text-left" style={{listStyle: 'outside none none'}}>
            <a href="/portfolio" className="text-2xl leading-4 cursor-pointer text-slate-900 hover:text-slate-500" style={{transition: 'color 300ms ease 0s', textDecoration: 'none', listStyle: 'outside none none'}}>Portfolio</a>
          </li>
          <li className="py-2 mr-0 mb-4 text-left" style={{listStyle: 'outside none none'}}>
                  ...
                  <div className="box-border" style={{listStyle: 'outside none none'}}>
                    ...
                    <div className="flex-col" style={{listStyle: 'outside none none'}}>
                      <ul role="list" className="pl-0 my-0 mr-16 list-none box-border" style={{listStyle: 'none'}}>
                        <li className="mb-3 box-border" style={{listStyle: 'outside none none'}}>
                          <a href="/" className="block relative p-0 mx-auto align-top whitespace-nowrap bg-transparent cursor-pointer box-border text-slate-900 hover:text-slate-500" tabIndex={0} style={{transition: 'color 350ms ease 0s', textDecoration: 'none', listStyle: 'outside none none'}}>Home</a>
                        </li>
                        <li className="mb-3 box-border" style={{listStyle: 'outside none none'}}>
                          <a href="/about" className="block relative p-0 mx-auto align-top whitespace-nowrap bg-transparent cursor-pointer box-border text-slate-900 hover:text-slate-500" tabIndex={0} style={{transition: 'color 350ms ease 0s', textDecoration: 'none', listStyle: 'outside none none'}}>About</a>
                        </li>
                        <li className="mb-3 box-border" style={{listStyle: 'outside none none'}}>
                          <a href="/contact" className="block relative p-0 mx-auto align-top whitespace-nowrap bg-transparent cursor-pointer box-border text-slate-900 hover:text-slate-500" tabIndex={0} style={{transition: 'color 350ms ease 0s', textDecoration: 'none', listStyle: 'outside none none'}}>Contact</a>
                        </li>
                        <li className="mb-3 box-border" style={{listStyle: 'outside none none'}}>
                          <a href="/portfolio" className="block relative p-0 mx-auto align-top whitespace-nowrap bg-transparent cursor-pointer box-border text-slate-900 hover:text-slate-500" tabIndex={0} style={{transition: 'color 350ms ease 0s', textDecoration: 'none', listStyle: 'outside none none'}}>Portfolio</a>
                        </li>
                        <li className="mb-0" style={{listStyle: 'outside none none'}}>
                          <a href="https://youtemplate.webflow.io/portfolio-project/todo-list-mobile-app-redesign" className="block relative p-0 mx-auto align-top whitespace-nowrap bg-transparent cursor-pointer box-border text-slate-900 hover:text-slate-500" tabIndex={0} style={{transition: 'color 350ms ease 0s', textDecoration: 'none', listStyle: 'outside none none'}}>Single Project</a>
                        </li>
                      ...
                      <ul role="list" className="pl-0 my-0 mr-16 list-none box-border" style={{listStyle: 'none'}}>
                        <li className="mb-3 box-border" style={{listStyle: 'outside none none'}}>
                          <a href="/shop" className="block relative p-0 mx-auto align-top whitespace-nowrap bg-transparent cursor-pointer box-border text-slate-900 hover:text-slate-500" tabIndex={0} style={{transition: 'color 350ms ease 0s', textDecoration: 'none', listStyle: 'outside none none'}}>Shop</a>
                        </li>
                        <li className="mb-3 box-border" style={{listStyle: 'outside none none'}}>
                          <a href="https://youtemplate.webflow.io/product/iphone-12-pro-max-mockups" className="block relative p-0 mx-auto align-top whitespace-nowrap bg-transparent cursor-pointer box-border text-slate-900 hover:text-slate-500" tabIndex={0} style={{transition: 'color 350ms ease 0s', textDecoration: 'none', listStyle: 'outside none none'}}>Single Product</a>
                        </li>
                        <li className="mb-3 box-border" style={{listStyle: 'outside none none'}}>
                          <a href="/blog" className="block relative p-0 mx-auto align-top whitespace-nowrap bg-transparent cursor-pointer box-border text-slate-900 hover:text-slate-500" tabIndex={0} style={{transition: 'color 350ms ease 0s', textDecoration: 'none', listStyle: 'outside none none'}}>Blog</a>
                        </li>
                        <li className="mb-3 box-border" style={{listStyle: 'outside none none'}}>
                          <a href="https://youtemplate.webflow.io/blog/what-did-i-learn-from-doing-50-design-sprints" className="block relative p-0 mx-auto align-top whitespace-nowrap bg-transparent cursor-pointer box-border text-slate-900 hover:text-slate-500" tabIndex={0} style={{transition: 'color 350ms ease 0s', textDecoration: 'none', listStyle: 'outside none none'}}>Blog Post</a>
                        </li>
                  ...
                  <div className="box-border" style={{listStyle: 'outside none none'}}>
                    ...
                    <div className="flex-col" style={{listStyle: 'outside none none'}}>
                      <ul role="list" className="pl-0 my-0 mr-0 list-none box-border" style={{listStyle: 'none'}}>
                        <li className="mb-3 box-border" style={{listStyle: 'outside none none'}}>
                          <a href="/utility-pages/style-guide" className="block relative p-0 mx-auto align-top whitespace-nowrap bg-transparent cursor-pointer box-border text-slate-900 hover:text-slate-500" tabIndex={0} style={{transition: 'color 350ms ease 0s', textDecoration: 'none', listStyle: 'outside none none'}}>Styleguide</a>
                        </li>
                        <li className="mb-3 box-border" style={{listStyle: 'outside none none'}}>
                          <a href="/utility-pages/start-here" className="block relative p-0 mx-auto align-top whitespace-nowrap bg-transparent cursor-pointer box-border text-slate-900 hover:text-slate-500" tabIndex={0} style={{transition: 'color 350ms ease 0s', textDecoration: 'none', listStyle: 'outside none none'}}>Start Here</a>
                        </li>
                        <li className="mb-3 box-border" style={{listStyle: 'outside none none'}}>
                          <a href="/404" className="block relative p-0 mx-auto align-top whitespace-nowrap bg-transparent cursor-pointer box-border text-slate-900 hover:text-slate-500" tabIndex={0} style={{transition: 'color 350ms ease 0s', textDecoration: 'none', listStyle: 'outside none none'}}>404 Not Found</a>
                        </li>
                        <li className="mb-3 box-border" style={{listStyle: 'outside none none'}}>
                          <a href="/401" className="block relative p-0 mx-auto align-top whitespace-nowrap bg-transparent cursor-pointer box-border text-slate-900 hover:text-slate-500" tabIndex={0} style={{transition: 'color 350ms ease 0s', textDecoration: 'none', listStyle: 'outside none none'}}>Password Protected</a>
                        </li>
                        <li className="mb-3 box-border" style={{listStyle: 'outside none none'}}>
                          <a href="/utility-pages/licenses" className="block relative p-0 mx-auto align-top whitespace-nowrap bg-transparent cursor-pointer box-border text-slate-900 hover:text-slate-500" tabIndex={0} style={{transition: 'color 350ms ease 0s', textDecoration: 'none', listStyle: 'outside none none'}}>Licenses</a>
                        </li>
                        <li className="mb-0" style={{listStyle: 'outside none none'}}>
                          <a href="/utility-pages/changelog" className="block relative p-0 mx-auto align-top whitespace-nowrap bg-transparent cursor-pointer box-border text-slate-900 hover:text-slate-500" tabIndex={0} style={{transition: 'color 350ms ease 0s', textDecoration: 'none', listStyle: 'outside none none'}}>Changelog</a>
                        </li>
                      </ul>
                    </div>
                  </div>
