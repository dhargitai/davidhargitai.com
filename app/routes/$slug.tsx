...
export default function Index() {
  ...
  return (
    <BasicLayout>
      <div className="py-8 sm:py-12 font-medium leading-8 text-dh-dark-light">
        <div className="table clear-both flex-col items-stretch  mx-auto leading-8" style={{maxWidth: '1248px', }}>
          <div className="relative py-8 px-5 sm:px-16 lg:px-32 sm:pt-10 sm:pb-20 text-dh-dark-light bg-white rounded-3xl" style={{zIndex: 2, marginBottom: heroImageBaseUrl ? '-260px' : '0' }}>
            <div className="box-border">
              ...
              <div className="flex flex-wrap items-center -mb-4 opacity-100">
                ...
                {categories.map(category => (
                  <a key={category.slug.current} href={`/category/${category.slug.current}`} className="py-4 px-8 mr-8 font-bold leading-5 bg-white border-dh-blue border-2 cursor-pointer text-dh-dark hover:bg-dh-blue hover:text-white" style={{textDecoration: 'none', transition: 'transform 300ms ease 0s, background-color 300ms ease 0s, color 300ms ease 0s, -webkit-transform 300ms ease 0s', borderRadius: '500px'}}>{category.title}</a>
                ))}
              </div>
            </div>
          </div>
      ...
      {heroImageBaseUrl && <div className="font-medium leading-8 text-dh-dark-light relative mb-8" style={{minHeight: '68vh'}}>
      ...
      <div className="pb-14 lg:pb-32 font-medium leading-8 text-dh-dark-light">
                ...
                <a href="/blog/what-is-the-right-design-tool-to-choose-in-2022" className="flex overflow-hidden flex-col max-w-full min-h-full bg-white border border-solid cursor-pointer box-border border-dh-dark-lighter hover:text-dh-dark-light" style={{transition: 'color 300ms ease 0s', textDecoration: 'none', borderRadius: '20px', transform: 'translate(0px, 0px)'}}><div className="flex flex-col justify-center h-48">
                  ...
                  <div className="px-6 pt-6 pb-12">
                    ...
                    <div className="flex flex-wrap items-center box-border">
                      ...
                      <div className="mx-3 w-5 bg-dh-dark-lighter" style={{minHeight: '1px'}} />
