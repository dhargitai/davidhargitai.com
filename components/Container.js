...
export default function Container(props) {
  ...
  const meta = {
    title: "David Hargitai - on a copywriter's journey.",
    description: `A digital marketing enthusiast writes words here and there.`,
    // image: 'https://davidhargitai.com/static/images/banner.png',
    type: 'website',
    ...customMeta
  };
  ...
  return (
    <div className="bg-white dark:bg-black">
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://davidhargitai.com${router.asPath}`}
        />
        <link
          rel="canonical"
          href={`https://davidhargitai.com${router.asPath}`}
        />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="David Hargitai" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="@hargitaidavid" />
